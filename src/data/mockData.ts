...
export const mockPatients: Patient[] = [
  {
    ...
    nextAppointment: '15/07/2025', // Hoje!
    documents: [],
  ...
  },
  {
    ...
    nextAppointment: '16/07/2025', // Amanhã
    documents: [],
...
export const mockAppointments: Appointment[] = [
  // Consultas para hoje (15/07/2025)
  {
    id: '1',
    patientId: '1',
  ...
  // Consultas para amanhã (16/07/2025)
  {
    id: '4',
    patientId: '2',
  ...
  // Consultas já realizadas (históricas)
  {
    id: '11',
    patientId: '1',
    patientName: 'Maria Silva Santos',
